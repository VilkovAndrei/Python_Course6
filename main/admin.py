...
class MailingAdmin(admin.ModelAdmin):
    list_display = ('id', 'start_time', 'frequency_mailing', 'status_mailing', 'message', 'clients', 'owner')
...
class MailingAttemptAdmin(admin.ModelAdmin):
    list_display = ('id', 'time_last_mailing', 'status_mailing', 'server_response', 'mailing')
